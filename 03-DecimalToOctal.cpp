...
void ConvertDecimalToOctal(std::string, std::string&);
...
int main(void) {
    ...
    ConvertDecimalToOctal(Input, Output);
...
void ConvertDecimalToOctal(std::string s, std::string& retVal){
    ...
    while(actualNumber){
        retVal.push_back(static_cast<char>(48 + (actualNumber % 8)));
        actualNumber /= 8;
    }
